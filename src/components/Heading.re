...
let make =
  ...
  ReasonReact.wrapJsForReason(
    ~reactClass,
    ~props={
      "italic": italic |> Option.map(Js.Boolean.to_js_boolean) |> Js.Nullable.from_opt,
      "bold": bold |> Option.map(Js.Boolean.to_js_boolean) |> Js.Nullable.from_opt,
      "caps": caps |> Option.map(Js.Boolean.to_js_boolean) |> Js.Nullable.from_opt,
      ...
      "fit": Js.Nullable.from_opt(fit),
      "lineHeight": Js.Nullable.from_opt(lineHeight)
    },
    children
  );