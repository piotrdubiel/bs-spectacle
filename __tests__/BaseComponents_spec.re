  ...
  describe(
    ...
    ExpectJs.(
      () => {
        test(
          "strikethrough",
          () => expect(S.sTypeFromJs("strikethrough")) |> toEqual(Some(`strikethrough))
        );
        test("underline", () => expect(S.sTypeFromJs("underline")) |> toEqual(Some(`underline)));
        test("bold", () => expect(S.sTypeFromJs("bold")) |> toEqual(Some(`bold)));
        test("italc", () => expect(S.sTypeFromJs("italic")) |> toEqual(Some(`italic)));
        test("should not match", () => expect(S.sTypeFromJs("sdaf")) |> toEqual(None))
      }
    )
  );
};
